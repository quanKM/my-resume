        ...
        <ul className="timeline timeline-centered mt-4">
          ...
          >
            ...
            <div className="timeline-content">
              ...
              <p className="ml-4">+ Project schedule planning.</p>
              <p className="ml-4">+ Assign tasks to the team members and review the code.</p>
            </div>
          </li>
          <li
          ...
          >
            ...
            <div className="timeline-content">
              ...
              <p className="ml-4">
                + Build multi stunning and scalable web applications using
                Laravel/NodeJs in the Backend and VueJs/NuxtJs or ReactJs/NextJs
                in the Frontend.
              </p>
              <p className="ml-4">+ Learn how to work with Docker.</p>
              <p className="ml-4">+ Provide solution and detail design.</p>
            </div>
          </li>
          <li
